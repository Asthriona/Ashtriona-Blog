<template>
  ...
  <section>
    <div id="footer" class="fcontainer footBack">
      <p>
        Code hosted on
        <a href="https://github.com/Asthriona/Ashriona-Blog" target="_blank">GitHub</a>. Website hosted by
        <a
          href="https://SiriusMediaGroup.com"
          target="_blank"
          rel="noopener noreferrer"
        >Sirius Media Group</a> DNS Powered by
        <a href="https://Asthriona.com" target="_blank" rel="noopener noreferrer">Asthriona ltd.</a>.
      </p>
      <p>
        Blog Uptime:
      ...
      <p>
        ...
        <a href="https://Asthriona.com">Asthriona</a>. Powered by
        <a href="https://vuejs.org/" target="_blank">Vue</a>. Theme By
        <a href="https://Asthriona.com/" target="_blank">Asthriona</a>.
      </p>
      <p>
        <span>Made with</span>❤️
        <span>by Asthriona.</span>
      </p>
    </div>
  </section>
</template>
